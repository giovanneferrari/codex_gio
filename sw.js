const CACHE_NAME='rito-shell-v29';
const APP_SHELL=['./','./index.html','./styles.css?v=push-diagnostic-29','./app.js?v=push-diagnostic-29','./manifest.webmanifest?v=4','./assets/rito-logo-transparent.png?v=1','./assets/rito-monograma.png','./assets/icons/favicon-32.png?v=4','./assets/icons/icon-192.png?v=4','./assets/icons/icon-512.png?v=4','./assets/icons/apple-touch-icon.png?v=4'];
