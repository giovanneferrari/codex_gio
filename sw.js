const CACHE_NAME='rito-shell-v41';
const APP_SHELL=['./','./index.html','./styles.css?v=event-cycle-40','./app.js?v=event-cycle-40','./manifest.webmanifest?v=5','./assets/rito-logo-transparent.png?v=1','./assets/rito-monograma.png','./assets/icons/favicon-32.png?v=5','./assets/icons/favicon-64.png?v=5','./assets/icons/icon-192.png?v=5','./assets/icons/icon-512.png?v=5','./assets/icons/apple-touch-icon.png?v=5'];
