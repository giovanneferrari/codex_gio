const CACHE_NAME='rito-shell-v51';
const APP_SHELL=['./','./index.html','./styles.css?v=installment-total-50','./app.js?v=installment-total-50','./manifest.webmanifest?v=5','./assets/rito-logo-transparent.png?v=1','./assets/rito-monograma.png','./assets/icons/favicon-32.png?v=5','./assets/icons/favicon-64.png?v=5','./assets/icons/icon-192.png?v=5','./assets/icons/icon-512.png?v=5','./assets/icons/apple-touch-icon.png?v=5'];
